...
class wd_ads_admin {
	...
	function wd_ads_create_logo_to_head() {
			...
			<div>
				<div class="wd_ads_upgrade wd_ads-clear">
					<div class="wd_ads-right">
						<a href="https://web-dorado.com/products/wordpress-ad-manager-wd.html" target="_blank">
							<div class="wd_ads-table">
								<div class="wd_ads-cell wd_ads-cell-valign-middle">
									Upgrade to paid version
								</div>

								<div class="wd_ads-cell wd_ads-cell-valign-middle">
									<img src="<?php echo WD_ADS_URL ?>/images/web-dorado.png">
								</div>
							</div>
						</a>
					</div>
		...
		switch ( $screen->id ) {
            ...
            <a style="color: blue; text-decoration: none;" target="_blank" href="https://web-dorado.com/ad-manager-wd/creating-advertisement.html">Read More in User Manual</a>
        </div>';
            ...
            <a style="color: blue; text-decoration: none;" target="_blank" href="https://web-dorado.com/ad-manager-wd/creating-advertisement/new-advert.html">Read More in User Manual</a>
        </div>';
            ...
            <a style="color: blue; text-decoration: none;" target="_blank" href="https://web-dorado.com/ad-manager-wd/groups.html">Read More in User Manual</a>
        </div>';
            ...
            <a style="color: blue; text-decoration: none;" target="_blank" href="https://web-dorado.com/ad-manager-wd/schedules.html">Read More in User Manual</a>
        </div>';
            ...
            <a style="color: blue; text-decoration: none;" target="_blank" href="https://web-dorado.com/ad-manager-wd/settings.html">Read More in User Manual</a>
        </div>';
            ...
            <a style="color: blue; text-decoration: none;" target="_blank" href="https://web-dorado.com/ad-manager-wd/import.html">Read More in User Manual</a>
        </div>';
...
*/
	...
	public function wd_ads_enqueue_admin_scripts() {
		...
		wp_enqueue_script( $this->prefix . '-highcharts', plugins_url( 'js/highcharts.js', __FILE__ ), array( 'jquery' ), $this->version );
