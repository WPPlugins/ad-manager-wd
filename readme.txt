...
Donate link:  https://web-dorado.com/products/wordpress-ad-manager-wd.html 
...
[Ad Manager WD User Manual](https://web-dorado.com/wordpress-gallery-guide-step-1.html)  
[Ad Manager WD Support Forum](https://web-dorado.com/forum/ad-manager-wd.html) 

Start creating your ad with an advertisement banner, and you can display it on any page, post, category page or sidebar area with an ad widget. Absolutely no need to get a separate banner manager or affiliate plugin. Ad Manager WD does it all. With its flexible functionality, Ad Manager WD supports almost any type of ad code and lets you manage multiple banners. Whether you’ve got it in an HTML markup, Javascript code or specific advertisement script (e.g. Google AdSense, Chitika, Amazon, BuySellAds,), you can publish it with this WordPress plugin. It is widely used on commercial websites ,in affiliate marketing and other affiliate programs with commission. Organize your ads by adding them into ad groups, and publish ad groups in three modes. Ads can be renewed upon reloading the page with Default mode, as well as be refreshed dynamically with Dynamic. You can also place more than one advert on the same area using Block mode of ad groups.The plugin supports ad rotation. You can adjust the ad rotating settings from the Groups section in the plugin settings.Ad Manager WD WordPress plugin lets you publish your ads with ad inserter functionality by injecting them into posts, pages or categories. Ad injections can be made before or after the page content, or inside it. Select a specific paragraph, and inject the ad next to it. The ads are perfectly displayed on AMP.Furthermore, you can have your ads published based on a certain schedule and advertise saving time and efforts. Set start and end dates for your ad schedule and apply it to your ads. They will be unpublished from your website automatically, when the end date of the schedule is passed. This feature-rich affiliate tool is a great way to manage home page ads,target your niche audience and make some more income.Export functionality of Ad Manager WD allows to download JSON file with created ads. You can then import them into the plugin installed on another website.Th plugin is multisite compatible to help you display adverts on multiple sites and make more revenue. Track the statistics of your ads with Internal Tracker of Ad Manager WD plugin. Configure tracking settings and you will have in-depth information regarding clicks and impressions on your ads.As an administrator of your WordPress site, you act as an advert manager, and receive email notifications from Ad Manager WD plugin. They can be triggered when an ad is saved by any advertiser, or is approved by site moderators.There are many browser extensions, which block ads on websites, and one of them is AdBlock. Ad Manager WD plugin provides AdBlock Detection feature. It lets you catch AdBlock in case it is enabled on visitors’ browsers and notify them about it. You can set a custom text to display as AdBlock detector message.
...
###IMPORTANT:    
If you think you found a bug in Ad Manager WD or have any problem/question concerning the plugin, please check out [Ad Manager WD Support Forum](https://web-dorado.com/forum/ad-manager-wd.html) in our website. If you do not find a solution here, do not hesitate to [click here to contact us](https://web-dorado.com/support/contact-us.html).


### Features of Ad Manager WD plugin:

*   Unlimited ads and ad groups  
*   User-friendly interface  
*   Ad scheduling  
*   3 display modes for ad groups:  
	*   Default  
	*   Dynamic  
	*   Block  
*   Exporting/importing created ads   
*   AdBlock detection   
*   Clicks and impressions tracker for ads   
*   Email notifications   
...
= 1. What can I get with Ad Manager WD plugin? =

Ad Manager WD is a user-friendly tool which lets you easily create and manage ads on your WordPress websites. It allows publishing the ads as a single entry or a group, and each of the ads can appear on your website based on a certain schedule.

= 2. Can Ad Manager WD plugin be installed via FTP? =

Installation through WordPress administrative panel is recommended, however, you can install the plugin with FTP connection. Connect to your website server and navigate to /wp-content/plugins directory. Uncompress the .zip installation file of Ad Manager WD plugin, then upload it to /wp-content/plugins.

Afterwards login to WordPress administrative panel of your site, go to Plugins page and activate Ad Manager WD.

= 3. How many ads can I add with the plugin? =

Ad Manager WD plugin lets you create and publish unlimited numbers of advertisement entries on your WordPress site. 

= 4. Can I use Google AdSense code? =

You can have your Ad Code in HTML/CSS and Javascript code, as well as specific ad script, such as Google AdSense.

Important: Ad Code does not accept PHP. Please avoid writing PHP code as the value of Ad Code option, since the site will throw errors and stop functioning properly until the code is removed.

= 5. How can I publish my ads on my WordPress site? =
...
= 6. Can the ads be published based on a schedule? =

You can create schedules from Ad Manager WD Schedules page, and add one schedule to each ad entry. Specify start and end dates, and your ads will appear during the specified time frame.

= 7. Is it possible to categorize ads in groups? =

Ad Manager WD plugin lets you create groups for your ads, which are WordPress taxonomies. Ad groups allows you to bulk publish more than one ads in pages, posts, categories or widget areas. 

= 8. Which are the views available for ad groups? =

Ad groups can be published with three types of views, Default, Dynamic or Block. Ad groups published with Default mode will refresh displayed ad when the page is reloaded. Whereas Dynamic lets you have them renewed automatically after a specified period of time.

Block mode of Ad Manager WD plugin aligns ads of the group in a grid. It lets you display more than one ad on the same area of your WordPress site.

= 9. How can I transfer created ads from one website to another? =

Ad Manager WD plugin lets you export created ads in a JSON file. Select your ads from All Adverts page choose Export to JSON from Bulk Actions and click Apply. The JSON file with ads will be downloaded automatically.

You can then upload this file from Ad Manager WD > Import page.

= 10. Is it possible to detect AdBlock and ask visitors to disable it? =
...
= 11. How can I get notified when an ad is created or approved? =

Ad Manager WD can send email notifications to site administrators, when an advertiser saves an ad on your website, and also when a moderator approves an ad. Enable notification options from Ad Manager WD > Settings > General tab, and provide the email addresses of recipients, separated by commas.

= 12. Can I track clicks and impressions of my ads? =

Internal Tracker of Ad Manager WD plugin lets you have statistics of clicks and impressions of each ad you create. Enable Statistics option when creating an ad, and make sure Internal Tracker is selected on Ad Manager WD > Settings page, Statistics tab.

You will be able to display tracking information of each ad from All Adverts page, Statistics column.



== Installation ==

#### Thank you for your interest in Ad Manager WD.  
...
==Wordpress Ad Manager WD Step by step guide==    
...
Specific advertisement code, such as Google AdSense.
 ...
 Note: You’ll be able to use ad codes from any advertising platform,company and affiliate networks (Adserver ,AdGridwork, Adify, Adpinion, Adroll, CrispAds,Adbrite, shopping ads,Ad Rotator) that use Javascript, HTML and CSS.Important: This option does not accept PHP code. Please avoid adding it to Ad Code setting.
...
As soon as the code for the advertisement is provided, you will be able to see a quick preview of it. Mark Statistics option as checked to enable tracking of clicks and impressions of this advert.
...
Use Sortorder to set ordering of adverts in the same group displayed with Block type as its Mode. Alternatively you can skip this by leaving the option empty or setting it to 0. We will thoroughly cover ad group modes in Groups section of this user guide.
...
You can determine the placement of your advertisement with this set of options. Ad Manager WD plugin lets you add your adverts to widget areas, categories, posts and pages. We will discuss publishing of widgets later on in this guide. Let’s go through the rest of its methods now.
...
This option of Ad Manager WD plugin allows you to place additional code before and after the advertisement. It accepts HTML, CSS and Javascript code. Alternatively you can leave it blank, if you don’t need a wrapper around the ad.
...
= Managing All Adverts =When you create a few advertisement entries, they all will be available under Ad Manager WD page. This section also provides a set of useful tools, which will come handy for affiliates managers . Let’s go through each of them and discuss thoroughly.
...
Apply the schedules to advertisement entries using corresponding checkboxes under Adverts section.

= Settings =

Ad Manager WD provides various useful settings, which makes the functionality of the adverts more flexible. You can configure alert messages, geo targeting options, administrative roles and much more. Navigate to Ad Manager WD > Settings and let’s go through each section and options one by one.

General

Ad Block Detection can be enabled to have a message in case Ad blocker extensions are enabled on user’s browser. The message will appear as an overlay on your website frontend. With Show message for setting you can select the interval (in seconds) during which this message will be displayed. Furthermore, set the message content for Adblock detection using Message to show option.

Bot Filter option lets you provide list of bots, which will otherwise interact with your adverts. We provide a predefined list, which you can keep for this setting.
Send Notification When lets you enable email or Pushover notifications to keep track of changes among your adverts. These alert messages can be sent for the following two cases:
...
This section lets you configure tracking settings for checking the statistics of your adverts created with Ad Manager WD. Three options of tracking tools are available:
...
If you wish to have geo targeting functionality on your advertisement entries, you can select one of the two Geo Services from this section. WD Adverts uses the free version of Max Mind geo targeting service. It is precise and will let you target all specified locations correctly.
...
Advertisement and Schedule Roles
...
Ad Manager WD plugin lets you export created adverts from one website, and import to another one with its Import feature. Firstly go to Ad Manager WD > All Adverts page to export the entries. Select the necessary items, choose Export JSON option from Bulk Action, then click Export.
