...
<div id="wd_ads_stat_container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
...
jQuery(function () {
    jQuery('#wd_ads_stat_container').highcharts({
		toolTip: {
			shared: true
				
			},
        title: {
            text: 'Statistics of clicks and impressions for <?php echo $title!='' ? $title : '(no title)' ?>',
            x: -20 //center
        },
        subtitle: {
            text: '',
        ...
        series: [{
            name: 'Clicks',
            data: [<?php foreach($dates as $date) 
				{
